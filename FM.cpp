...
FM::FM(const char *fileName, int speedlevel) :wt(fileName, 256, 8, 1, speedlevel){  }
FM::FM(unsigned char * str, int length, int speedlevel) : wt(str, length, 256, 8, 1, speedlevel){  }
FM::FM():wt(){}
